...
abstract class WireEventsHandlerSuspending : WireEventsHandler() {
    ...
    open suspend fun onCallingMessageReceived(message: WireMessage.Calling) {}
     ...
     */
    open suspend fun onSubconversationEpochChanged(info: SubconversationEpochInfo) {
        info.close()
    }
    ...
    open suspend fun onCallingError(
