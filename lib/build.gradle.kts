...
dependencies {
    ...
    implementation("app.cash.sqldelight:sqlite-driver:2.3.1")
    implementation("app.cash.sqldelight:sqlite-3-24-dialect:2.3.1")
...
sqldelight {
    databases {
        register("AppsSdkDatabase") {
            ...
            dialect("app.cash.sqldelight:sqlite-3-24-dialect:2.3.1")
